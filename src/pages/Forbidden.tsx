...
export const Forbidden: React.FC<ForbiddenProps> = ({ onBack }) => (
  <div className="min-h-screen flex flex-col items-center justify-center bg-[#fffefc] p-8">
    ...
    <h1 className="text-2xl font-semibold mb-2">Bạn không có quyền truy cập trang này</h1>
    <p className="text-gray-600 mb-6">Vui lòng liên hệ quản trị viên nếu bạn nghĩ đây là nhầm lẫn.</p>
    {onBack && (
